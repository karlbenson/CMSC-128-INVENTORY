...
<html>
	...
	<body>
		<div id="container-fluid">
			<h1 class="jumbotron-fluid text-center py-4" style="font-size: 50px"><em>Full Transaction History</h1>
		</div>
		...
		<div class="container" style="background-color: #edeef2; padding: 20px; margin-bottom: 50px; border-radius: 10px; border:2px solid #dbdbdb;">
			...
			<h1 class="jumbotron-fluid py-4 text-center" style="font-size: 50px"><em>Glassware</em></h1>
			<div>
			...
			<div>
				<table class="table table table-striped table-hover" id="table_id2">
					<thead class="text-center" >
					            	<tr>
